      ...
      >
        ...
        >
          <Grid {...{ xs: 12, [layoutQuery]: 3 }}>
            ...
            >
              The starting point for your next project, built on the newest version of Material-UI
    ...
    >
      <Container>
        ...
        <Box sx={{ mt: 1, typography: 'caption' }}>
          © All rights reserved.
          <br /> made by
          <Link href="https://www.linkedin.com/in/hazem-al-shibani/"> Hazem Al Shibani </Link>
        </Box>
      </Container>
    </Box>
  );
