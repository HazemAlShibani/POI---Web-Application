        ...
        <Container sx={{ textAlign: { xs: 'center', md: 'left' } }}>
          ...
          >
            <Grid xs={12} md={8} lg={8}>
              <SectionCaption title="say Hi to our participants!" />
              <SectionTitle title="Large bundle of" txtGradient="Debaters & Ideas" sx={{ mt: 3 }} />
            </Grid>
        ...
        <StyledContent ref={scrollRef} layout>
          ...
          <StyledItem
            ...
            sx={{
              ...
              width: { xs: '600%', md: '400%' },
              backgroundImage: `url(${CONFIG.site.basePath}/assets/images/home/bundle-${theme.palette.mode}-2-final.webp)`,
            }}
          />
        </StyledContent>
      </StyledContainer>
