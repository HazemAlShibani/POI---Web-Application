    ...
    >
      ...
      >
        <Box
          component="img"
          alt="Home Chart"
          src={`${CONFIG.site.basePath}/assets/images/home/final.webp`}
          sx={{ width: 720 }}
        />
      </Box>
    </Stack>
...
const ITEMS = [
  {
    ...
    description: 'Organize your points with precision using intuitive debate frameworks.',
  },
  {
    icon: `${CONFIG.site.basePath}/assets/icons/home/ic-design.svg`,
    title: 'Real time Interaction',
    description: 'Engage in dynamic discussions with instant feedback and audience participation.',
  },
  {
    icon: `${CONFIG.site.basePath}/assets/icons/home/ic-development.svg`,
    title: 'Comprehensive Moderation',
    description:
      'Manage debates effortlessly with built-in tools for fair and balanced discussions.',
  },
];
