      ...
      <Grid container spacing={3}>
        ...
        <Grid xs={12} md={6} lg={4}>
          <AppCurrentDownload
            ...
            chart={{
              series: [
                { label: 'Political', value: 15 },
                { label: 'Social', value: 20 },
                { label: 'Emotional', value: 50 },
                { label: 'Controversial', value: 40 },
              ],
            }}
          />
        </Grid>
        ...
        <Grid xs={12} md={6} lg={4}>
          <AppTopAuthors title="Top Debaters" list={_appAuthors} />
        </Grid>
        ...
        <Grid xs={12} md={6} lg={4}>
          <Box sx={{ gap: 3, display: 'flex', flexDirection: 'column' }}>
            ...
            <AppWidget
              ...
              chart={{
                series: 32,
                // colors: [theme.vars.palette.info.light, 'brown'],
              }}
              sx={{ bgcolor: 'brown', [`& .${svgColorClasses.root}`]: { color: 'info.light' } }}
            />
          </Box>
        </Grid>
      </Grid>
